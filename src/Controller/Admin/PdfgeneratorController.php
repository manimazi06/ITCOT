...
{	
	...
	public function receiptdownload($id = null)
	{
		...
		$html = "<html lang='en'>
		  ...
		  <body>
			...
			<td style='text-align:center;' colspan='3'>
			  ...
			  <br><br>
			  	<h3>Payment Receipt For Project Report</h3>
				</td>		 
		<br><br><br>
			  </tr>
		<tr>
			<td style='text-align:center;'>Transaction No:$value->transaction_number</td>
			<td style='text-align:center;' colspan='2'>Date-$date</td>			
		</tr>
		<tr>
		...
		<tr>
		<td>$value->name <br><br>$value->mobile_no </td>
	 ...
	 <table border='1'>
		...
		<tr>
			...
			<td style='text-align:right;'>$value->transaction_amount</td>
...
<h5>2.1 PRODUCTION PROGRAMME</h5>
		...
		<div class='col-sm-12 col-md-12'>
			<table class='table table-bordered responsive'>
				...
				<tbody class='rawadding'>";
				$manpower_no=1;
				foreach ($man_details as $key => $value6) {
						$html .="<tr>
							<td align='center'>$manpower_no</td>
							<td>";if($value6->particular_id == 1){
                                        
								$html .="<span> Skilled</span>";
								}elseif($value6->particular_id == 2)

								{
									$html .="<span> Semi-skilled</span>";
								}elseif($value6->particular_id == 3)
						...
						$no_s+= $value6->numbers ? $value6->numbers:0 ;

						$salaries+= $value6->salaries ? $value6->salaries :0;
				$manpower_no++;
				}
			   $html .=" </tbody>
				<tfoot>
	...
	public function compliancepdf($id = null)
	{
		...
		$basic = $this->ComplianceServices->get($id, [
			'contain' => ['States','Districts'],
			 ...
			 $state=$basic['state']['state_name'];
			 $district=$basic['district']['name'];
	

			 //$basic   = $this->ComplianceServices->find('all')->contain(['States','Districts'])->where(['ComplianceServices.is_active'=>1])->first();
			...
			//    echo '<pre>';
			//    print_r($serviceCompliances_data);
			//    exit();

			  // $service=$serviceCompliances_data[0]['service_compliance']['name'];
			  ...
			  // $unit_name=($complainceServiceProducts[0]['unit']);	
			...
			<section style='width: 700px; margin-left: auto; margin-right: auto'>		
			  ...
			  <tr>			  
				<td style='text-align:center;' colspan='3'>
					...
					<h3>Compliance Services-Application No:<br>
					$basic->application_no</h3>
        ...
        <!--General Details-->
					<div class='table-responsive'>
						...
						<table border='1'>
							...
							<tbody>      
								...
								<td align='center'> $basic->name </td>
								<td align='center'> $basic->mobile_no </td>
								<td align='center'> $basic->email </td>
			  ...
			  <table border='1'>
				  ...
				  <tbody>   
					  ...
					  <td align='center'> $basic->pincode</td>
					  </tr>
				  </tbody>
			  </table>	
			<br><br>
			  ...
			  <h3>Project Cost:$basic->project_cost/-</h3>
		  </div><br>
		  <!--Product Details details--1-->
		  <div class='table-responsive'>
		  ...
		  <table border='1'>
			  ...
			  <tbody>";
			  	$no=1;
		foreach ($complainceServiceProducts as $key => $value) {
        ...
        <div class='row'>
            <div class='col-sm-12 col-md-12'>
                <table border='1'>
                    ...
                    <tbody>";
							$no=1;
                        foreach ($serviceCompliances_data as $key1 => $value1) {

							// echo '<pre>';
							// print_r($key1);

							$service=$value1['service_compliance']['name'];
					 ...
					 if($value1->service_compliance_id==12){


						$html .="
						<td style='font-weight:normal !important;' align='center'>Others:$value1->others_name </td>";                        
				}else{
					$html .="<td>$service</td>"; 
				}
...
$html .="<h3>Message:</h3>
  ...
  $html .="  </div>
	...
	$mpdf->AddPage('P', '', '', '', '', 19, 20, 20, 22, 0, 0);
	$mpdf->WriteHTML($html);
	$filename = 'ComplianceService.pdf';
	//$fileroot = $filename;
	$mpdf->Output($filename, 'D');
	$this->set(compact('filename'));
	// $mpdf->Output();
	...
	public function virtualpdf($id = null)
	{
		...
		$basic = $this->VirtualcfoRegistrations->get($id, [
			'contain' => ['VirtualcfoStates','Services'],
			 ...
			 $VirtualServices   = $this->VirtualServices->find('all')->contain(['VirtualcfoRegistrations','Services'])->where(['VirtualServices.is_active'=>1,'VirtualServices.virtualcfo_registration_id'=>$id,
			 ])->toArray();

			 date_default_timezone_set("Asia/Kolkata");
			 $date=date('d-M-Y/h:i:sa');
			 $state=$basic['virtualcfo_state']['name'];
			 $service=$basic['service']['name'];
			...
			<section style='width: 700px; margin-left: auto; margin-right: auto'>		
			  ...
			  <tr>			  
				<td style='text-align:center;' colspan='3'>
					...
					<h3>Virtual CFO-Appln No-$basic->application_no</h3>
					...
					<div class='table-responsive'>
						...
						<table border='1'>
							...
							<tbody>      
								...
								<td align='center'> $basic->description </td>
						...
						<div class='row'>
							<div class='col-sm-12 col-md-12'>
								<table border='1'>
									...
									<tbody>";
											$no=1;
										foreach ($VirtualServices as $key1 => $value1) {
				
											// echo '<pre>';
											// print_r($key1);
				
											$service=$value1['service']['name'];
  ...
  $html .=" 
	...
	public function epfpdf($id = null)
	{
		...
		$basic = $this->Eprcertification->get($id, [
			'contain' => ['States','EprRoles','WasteTypes','WasteCategories','WasteProductDetails'],
			 ...
			 $role=$basic->epr_role->name;

			 $product_details  = $this->WasteProductDetails->find('all')->contain(['WasteTypes','WasteCategories'])->first();
			 
			 $waste_type=$product_details['waste_type']['name'];
			 $waste_category=$product_details['waste_category']['name'];
			...
			<section style='width: 700px; margin-left: auto; margin-right: auto'>		
			  ...
			  <tr>			  
				<td style='text-align:center;' colspan='3'>
					...
					<h3>EPR Certification-Appln No-$basic->application_no</h3>
					...
					<div class='table-responsive'>
						...
						<table border='1'>
							...
							<tbody>      
								...
								<td align='center'> $waste_type </td>
								<td align='center'> $waste_category </td>
								<td align='center'> $product_details->product_code </td>
								<td align='center'> $product_details->product_name </td>
