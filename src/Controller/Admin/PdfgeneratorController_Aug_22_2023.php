...
{	
	...
	public function downloadpdf($id = null)
	{
		...
		$util_details  = $this->Utilities->find('all')->where(['Utilities.project_id'=>$id])->first();

		$man_details  = $this->Manpowers->find('all')->where(['Manpowers.project_id'=>$id])->first();
			$electricity_unit_id = $util_details['electricity_unit_id'];
		...
		$fixed_capitals  = $this->FixedCapitals->find('all')->where(['FixedCapitals.project_id'=>$id])->first();
							...
							<table class='table table-bordered responsive'>
								...
								<tbody class='rawadding'>";
									  ...
									  $html .= "<tr>
											...
											<td>Electricity</td>
											<td style='text-align:right;'> $util_details->electricity_requirement </td>
											<td> $unit_value_electricity</td>
											<td style='text-align:right'> $util_details->electricity_expenses </td>
											<td> $util_details->electricity_remarks </td>
										</tr>
										<tr>
										...
										$elec_req  += $util_details->electricity_requirement + $util_details->water_requirement
											+ $util_details->oil_requirement + $util_details->other_requirement;
	
										$expenses += $util_details->electricity_expenses + $util_details->water_expenses
											+ $util_details->oil_expenses + $util_details->other_expenses;                                   
			...
			<table class='table table-bordered responsive'>
				...
				<tbody class='rawadding'>";
						...
						$html .="<tr>
							...
							<td style='text-align:right;'>
								 $man_details->skilled_no </td>
							<td style='text-align:right'>
								 $man_details->skilled_salaries </td>
							<td>
								 $man_details->skilled_remarks </td>
						</tr>
						<tr>
							<td align='center'>2.</td>
							<td>Semiskilled
						...
						$no_s              += $man_details->skilled_no + $man_details->semiskilled_no
							+ $man_details->unskilled_no + $man_details->office_no;

						$salaries += $man_details->skilled_salaries + $man_details->semiskilled_salaries
							+ $man_details->unskilled_salaries + $man_details->office_salaries;
							...
							<table class='table table-bordered responsive'>
								...
								<tbody class='rawadding'>							
									<tr>
										...
										$fixed              = $fixed_capitals->land_value + $fixed_capitals->machinery_value
											+ $fixed_capitals->furniture_value;
							...
							<table class='table table-bordered responsive'>
								...
								<tbody class='rawadding'>
										...
										<tr>
											...
											<td>
												 $working_capital->raw_duration </td>
											<td style='text-align:right;'>
												 $working_capital->raw_quantity </td>
												 <td>$raw</td>
											<td style='text-align:right;'>
												 $working_capital->raw_value </td>
										...
										$duration              = $working_capital->raw_duration + $working_capital->semifinished_duration
											+ $working_capital->finished_duration + $working_capital->expenses_duration + $working_capital->bills_duration;
	
										$qty += $working_capital->raw_quantity + $working_capital->semifinished_quantity
											+ $working_capital->finished_quantity + $working_capital->expenses_quantity + $working_capital->bills_quantity;
	
										$val += $working_capital->raw_value + $working_capital->semifinished_value
											+ $working_capital->finished_value + $working_capital->expenses_value + $working_capital->bills_value;
							...
							<table class='table table-bordered responsive'>
								...
								<tbody class='rawadding'>									
										<tr>
											...
											<td style='text-align:right;'>
												 $means_finance->capital_finance_value </td>
											<td>
												 $means_finance->capital_finance_remark </td>                                       
										</tr>
										<tr>
											<td align='center'>2.</td>
											<td>Subsidy
										...
										$working  += $means_finance->capital_finance_value + $means_finance->subsidy_value
											+ $means_finance->loan_value + $means_finance->investment_value + $means_finance->other_value;
