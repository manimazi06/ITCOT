<tr class="complaince_docdetails_class_<?php echo $j ?> complaince_row_in_post">                                              
	...
	<td>
		...
		<td><?php echo $this->Form->control('complaince.'.$j.'.capacity', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Capacity','data-rule-required'=>true,'data-msg-required'=>'Capacity']); ?>
		</td>
