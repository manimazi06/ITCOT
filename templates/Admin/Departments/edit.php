...
<div class="card mt-5">
    ...
    <div class="card-body">
        ...
        <?php if($department['scheme_type_id']==2) { ?>
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    <label for="inputlname" class="control-label col-form-label">File Upload<span class="text-danger">*</span></label>
                    <?php echo $this->Form->control('file_upload', ['class' => 'form-control validdocs', 'type' => 'file', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'onchange' => 'validdocs(this)']); ?>
                    <?php if ($department['file_upload'] != '') {  ?>
                        <?php echo $this->Form->control('file_upload1', ['type' => 'hidden', 'value' => $department['file_upload']]); ?>

                        <a style="color:blue;" href="<?php echo $this->Url->build('/uploads/Govt_schemes/States/' . $department['file_upload'], ['fullBase' => true]); ?>" target="_blank"><span>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    <label for="inputlname" class="control-label col-form-label">Image Upload<span class="text-danger">*</span></label>
                    ...
                    <?php if ($department['image_upload'] != '') {  ?>
                        <?php echo $this->Form->control('image_upload1', ['type' => 'hidden', 'value' => $department['image_upload']]); ?>

                        <a style="color:blue;" href="<?php echo $this->Url->build('/uploads/Govt_schemes/States/' . $department['image_upload'], ['fullBase' => true]); ?>" target="_blank"><span>
                                <ion-icon name="document-text-outline"></ion-icon>View
                            </span></a>
                    <?php  } ?>
                </div>
...
<div class="col-sm-12 col-md-3">
    <div class="mb-4">
        ...
        <?php if ($department['file_upload'] != '') {  ?>
            ...
            <a style="color:blue;" href="<?php echo $this->Url->build('/uploads/Govt_schemes/Union/' . $department['file_upload'], ['fullBase' => true]); ?>" target="_blank"><span>
                    <ion-icon name="document-text-outline"></ion-icon>View
                </span></a>
        <?php  } ?>
    </div>
...
<div class="col-sm-12 col-md-3">
    <div class="mb-4">
        ...
        <?php if ($department['image_upload'] != '') {  ?>
            ...
            <a style="color:blue;" href="<?php echo $this->Url->build('/uploads/Govt_schemes/Union/' . $department['image_upload'], ['fullBase' => true]); ?>" target="_blank"><span>
                    <ion-icon name="document-text-outline"></ion-icon>View
                </span></a>
        <?php  } ?>
    </div>
