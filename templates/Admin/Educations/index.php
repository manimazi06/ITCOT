            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-advanced display" style="width: 100%" id="example4">
                    ...
                    <tbody>
                        ...
                        $sno = 1;
                        foreach ($educations as $education) : //echo"<pre>";print_r($employees);exit(); 
                        ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php echo $this->Html->link(('<i class="fas fa-edit"></i>'), ['action' => 'edit', $education->id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-light-primary text-primary btn-sm']); ?>
                                    <?php echo $this->Html->link(('<i class="fas fa-trash"></i>'), ['action' => 'delete', $education->id], ['escape' => false,'onclick'=>"return confirm('Are You Sure want to delete-$education->name')", 'class' => 'btn waves-effect waves-light btn-light-primary text-primary btn-sm']); ?>
