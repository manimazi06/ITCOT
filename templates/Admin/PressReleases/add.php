...
<div class="card mt-3">
    <div class="card-header" style="background-color: #243e04;">
        <h4 class="mb-0 text-white">Add Press Releases</h4>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    ...
                    <?php echo $this->Form->control('release_date', ['class' => 'form-control flatpickr', 'label' => false, 'type' => 'date', 'empty' => 'Select Release date', 'required']); ?>
                </div>
            </div>
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    <label for="inputlname" class="control-label col-form-label">Title<span class="text-danger">*</span></label>
                    <?php echo $this->Form->control('title', ['label' => false, 'type' => 'text', 'class' => 'form-control', 'placeholder' => 'Enter the title', 'onkeypress' => "return AvoidSpace(this.value)", 'required']); ?>
                </div>
            </div>
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    <label for="inputlname" class="control-label col-form-label">URL</label>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    ...
                    <?php echo $this->Form->control('submit_date', ['class' => 'form-control flatpickr', 'label' => false, 'type' => 'date', 'empty' => 'Select Submit date', 'required']); ?>
