...
<div class="col-12">
    <div class="card">
        <div class="card-header"style="background-color: #243e04;">
            <h4 class="mb-0 text-white">Project ProfileValues</h4>
        </div>
        <div class="card-body">
            <!-- <div class="row mb-2">
            ...
            <div class="row mb-2">
                ...
                <div class="col text-end">
                    <!-- <?php echo $this->Html->link(('<i class="fa fa-plus"></i>&nbsp; Add Project ProfileValues'), ['action' => 'add'], ['escape' => false, 'class' => 'btn btn-rounded btn-outline-info m-t-10 mb-2', 'target' => '_blank']); ?> -->
                    <?php echo $this->Html->link(('<i class="fa fa-plus"></i>&nbsp; Add Project ProfileValues'), ['action' => 'add'], ['escape' => false, 'class' => 'btn btn-rounded btn-outline-info m-t-10 mb-2']); ?>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-advanced display" style="width: 100%" id="example4">
                    ...
                    <tbody>
                        ...
                        $sno = 1;
                        foreach ($projectProfileValues as $user) : //echo"<pre>";print_r($employees);exit(); 
                        ?>
