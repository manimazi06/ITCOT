...
<div class="card mt-3">
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      ...
      <!--  <li class="nav-item">
        ...
        <li class="nav-item">
            <?php echo $this->Html->link(__('Educational<br>& work'), ['controller' => 'Projects', 'action' => 'educationdetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li>
        <!-- <li class="nav-item">
        ...
        <li class="nav-item">
            <?php echo $this->Html->link(__('Manufacturing'), ['controller' => 'Projects', 'action' => 'manufacturingdetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li>
        <!-- <li class="nav-item">
            <?php echo $this->Html->link(__('Utilities'), ['controller' => 'Projects', 'action' => 'tenderdetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li> -->
        <li class="nav-item">
            <?php echo $this->Html->link(__('Utilities <br>& Manpower'), ['controller' => 'Projects', 'action' => 'manpowerdetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li>
        <!-- <li class="nav-item">
        ...
        <!-- <li class="nav-item">
            <?php echo $this->Html->link(__('Capital <br>& Total Cost'), ['controller' => 'Projects', 'action' => 'projectcostdetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li> -->
        <li class="nav-item">
            <?php echo $this->Html->link(__('Project<br>Profitability'), ['controller' => 'Projects', 'action' => 'profitabilitydetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li>
        <li class="nav-item">
            <?php echo $this->Html->link(__('Supplementary<br>Details'), ['controller' => 'Projects', 'action' => 'suppliementarydetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li>
        <li class="nav-item">
            <?php echo $this->Html->link(__('References'), ['controller' => 'Projects', 'action' => 'referencedetails', $id], ['escape' => false, 'class' => 'nav-link']); ?>
        </li>
        <li class="nav-item">
