				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo ($project['project_status'] == 0)?"<span style='color:blue;'><b>In Progress</b></span>":(($project['project_status'] == 1)?"<span style='color:green;'><b>Approved</b></span>":"<span style='color:red;'><b>Rejected</b></span>"); ?></td>
							...
							<td align="center">
								...
								<?php echo $this->Html->link(('<i class="fas fa-view">Preview</i>'), ['action' => 'reportpdf', $project->id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-light-primary text-success btn-sm']); ?>
							</td>	   
