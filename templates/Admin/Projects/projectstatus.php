...
<div class="card mt-1">
    <div class="card-header" style="background-color: #243e04;">
        <h4 class="mb-0 text-white">Project Status</h4>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    <label for="inputlname" class="control-label col-form-label">Project Status<span class="text-danger">*</span></label>
                    <div class="form-control">
                    <?php echo $this->Form->control('project_status', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $proj, 'label' => false, 'error' => false, 'empty' => 'Select Status']); ?>
                </div>
            </div>
