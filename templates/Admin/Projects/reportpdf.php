            ...
            <div class="container">
                ...
                <div class="row">
					...
					foreach ($pro_details as $key => $value) { ?>
                                ...
                                <?php
					$pro_value +=$value['revenue_year'] ? $value['revenue_year'] :0;
				 } 
                        ...
                        <table class="table table-bordered responsive">
                            ...
                            <tbody class="trainingadding">
                                <?php  foreach ($mach_details as $key1 => $value1) {   ?>
                                    ...
                                    <?php
									$mac_value +=$value1['total_value'] ? $value1['total_value']:0;
								 } ?>
                        ...
                        <table class="table table-bordered responsive">
                            ...
                            <tbody class="workadding">
                                ...
                                ?>
                                    ...
                                    <?php
									$raw_value +=$value2['value'] ? $value2['value'] :0;
									$raw_revenue +=$value2['revenue_year'] ? $value2['revenue_year'] :0;
								}
									?>
								</tbody>
								<tfoot>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <table class="table table-bordered responsive">
                            ...
                            <tbody class="rawadding">
                                ...
                                <?php $nos=1;
                                 foreach ($util_details as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:right;"><?php echo $value['expense'] ?  $value['expense'] : 0 ; ?> </td>
                                ...
                                <?php
                                    $elec_req  += $value['requirement']? $value['requirement']:0;

                                    $expenses += $value['expense'] ?  $value['expense']:0;
                    ...
                    <div class="col-sm-12 col-md-12">
                        <table class="table table-bordered responsive">
                            ...
                            <tbody class="rawadding">
                                ...
                                <?php
                                    $manpower_nos              += $value1['numbers'] ? $value1['numbers']: '0';
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="2" style="text-align:right">Total</th>
                                    <th>
                                        <?php echo $manpower_nos ?ltrim($fmt->formatCurrency((float)$manpower_nos,'INR'),'₹'):'0.00'; ?> </th>
                                    <th style="text-align:right;">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <table class="table table-bordered responsive">
                            ...
                            <tbody class="rawadding">
                                ...
                                <?php
                                    $fixed += $value['capital_value'] ?  $value['capital_value'] :'0';
                                } ?>
                            </tbody>
                            <tfoot>
                                <tr>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <table class="table table-bordered responsive">
                            ...
                            <tbody class="rawadding">
									...
									<?php
										$duration              += $value1['duration'] ?  $value1['duration'] :'0';

										$qty                   += $value1['quantity'] ? $value1['quantity'] :'0';

										$val                   += $value1['value']? $value1['value'] : '0';
                        ...
                        <table class="table table-bordered responsive">
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="2" style="text-align:right">Total</th>
                                    <th style="text-align:right;">
                                        <?php echo $total_nos ? ltrim($fmt->formatCurrency((float) $total_nos,'INR'),'₹'):'0.00'; ?> </th>                                 
                                    </th>
                                </tr>
                            </tfoot>
                        </table>
