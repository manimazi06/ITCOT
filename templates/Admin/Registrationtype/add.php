...
<div class="card mt-5">
    <div class="card-header" style="background-color: #243e04;">
        <h4 class="mb-0 text-white">Add Registrationtype</h4>
    </div>
    <div class="card-body">
        ...
        <div class="row">         
            ...
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    ...
                    <?php echo $this->Form->control('name', ['label' => false,'type'=>'text', 'class' => 'form-control name',"minlength"=>"3","maxlength"=>"20",'onkeypress'=>"return AvoidSpace(this.value)", 'placeholder'=>'Enter Name', 'required']); ?>
                </div>
            </div>
            <div class="col-sm-12 col-md-3">
                <div class="mb-4">
