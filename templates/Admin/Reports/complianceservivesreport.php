<div class="row">
    <div class="col-sm-12">
        ...
        <?php if ($compliance_services != '') {  ?>
            <div class="card-box">
                <?php if (count($compliance_services) > 0) { ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                                ...
                                                foreach ($compliance_services as $compliance_service) : ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="text-center"><?php
                                                                                if ($compliance_service['rejected'] >0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="complianceservicereport(3)"><?php echo $compliance_service['rejected']; ?></a>
                                                            <?php } else {
                                                                                    echo "0";
                                                                                } ?>
                                                        </td>
                                                        ...
                                                        <!-- <td class="text-center"><?php
                                                                                if ($pending=$compliance_service['approved']+$compliance_service['rejected']) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="complianceservicereport(4)"><?php echo $pending_total=$compliance_service['pid']-$pending; ?></a>
                                                            <?php } else {
                                                                                    echo "0";
                                                                                } ?>
                                                        </td> -->
                                                        ...
                                                        <td class="text-center"><?php
                                                                ...
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="complianceservicereport(4)"><?php echo $compliance_service['pending']; ?></a>
                                                            <?php } else {
                                                                                    echo "0";
                                                                                } ?>
                                                        </td>
