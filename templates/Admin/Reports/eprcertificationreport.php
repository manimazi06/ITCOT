<div class="row">
    <div class="col-sm-12">
        ...
        <?php if ($eprcertifications != '') {  ?>
            <div class="card-box">
                <?php if (count($eprcertifications) > 0) { ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                                ...
                                                foreach ($eprcertifications as $eprcertification) : ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="text-center"><?php
                                                                ...
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="eprcertificationreport(4)"><?php echo $eprcertification['pending']; ?></a>
                                                            <?php } else {
                                                                                    echo "0";
                                                                                } ?>
                                                        </td>
