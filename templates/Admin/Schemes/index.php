...
<div class="col-12">
    <div class="card">
        <div class="card-header"style="background-color: #243e04;">
            <h4 class="mb-0 text-white">Schemes</h4>
        </div>
        <div class="card-body">
            <div class="row mb-2">
                ...
                <div class="col text-end">
                    ...
                    <?php echo $this->Html->link(('<i class="fa fa-plus"></i>&nbsp; Add Scheme'), ['action' => 'add'], ['escape' => false, 'class' => 'btn btn-rounded btn-outline-info m-t-10 mb-2']); ?>
                </div>
                <?php //} 
                ?>
            </div>
