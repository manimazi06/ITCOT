...
<div class="container" style="background-color:white;"><br><br>
    <div class="mb-3 mt-3 text-right" style="text-align:right;">
        <?php echo $this->Html->link(('<i class="fas fa-download"></i>&nbsp; Download pdf'), ['controller' => 'Pdfgenerator', 'action' => 'virtualpdf', $id], ['escape' => false, 'class' => 'btn btn-info rounded-pill px-4 waves-effect waves-light',]); ?>
    ...
    <div class="uniongov-content text-start">
        <h2 style="text-align: center;"><u>Virtual CFO-Preview</u></h2>
            ...
            <table class="table table-hover table-bordered table-advanced display" style="width: 100%">
                ...
                <tbody>
                    <tr class="text-center">
                        ...
                        <td class="text-center"><?= $basic->virtualcfo_state->name ?></td>
                        <!-- <td class="text-center"><?= $basic->service->name ?></td> -->
