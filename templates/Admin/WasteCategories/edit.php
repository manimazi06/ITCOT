...
<div class="card mt-5">
    ...
    <div class="card-body">
        ...
        <?php echo $this->Form->create($wasteCategories, ['id' => 'FormID', 'class' => 'form-horizontal', "autocomplete" => "off", 'enctype' => 'multipart/form-data']); ?>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-9">
                <div class="mb-4">
                    ...
                    <?php echo $this->Form->control('name', ['label' => false, 'class' => 'form-control name', 'type' => 'text', 'onkeypress' => "return AvoidSpace(this.value)", 'placeholder' => 'Enter Category', 'required']); ?>
                </div>
            </div>
        </div>
        <!-- <div class="row">
