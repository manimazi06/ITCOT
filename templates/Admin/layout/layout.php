            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <!-- Virtual CFO -->
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-grid"></i><span class="hide-menu">Services </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Virtual CFO'), ['controller' => 'VirtualcfoRegistrations', 'action' => 'virtualcfo'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                                </li>
                                ...
                                <!-- ComplianceServices -->
                                <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Compliance Services'), ['controller' => 'ComplianceServices', 'action' => 'index'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                                </li>


                                <!-- Eprcertification -->
                                <!-- <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">&nbsp;<span class="hide-menu">EPR Certification<i class="mdi mdi-grid"></i> </span></a> -->
                                <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp;&nbsp;EPR Certification'), ['controller' => 'Eprcertification', 'action' => 'eprcertification'], ['escape' => false, 'class' => 'sidebar-link']); ?></li>
                                ...
                                <!-- <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp;EPR'), ['controller' => 'Eprcertification', 'action' => 'eprcertification'], ['escape' => false, 'class' => 'sidebar-link']); ?></li> -->
                    ...
                    <!-- REPORTS -->
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-grid"></i><span class="hide-menu">Reports </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <!-- <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Project-report'), ['controller' => 'Reports', 'action' => 'projectreport'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                            </li>
                            <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Digital Library-report'), ['controller' => 'Reports', 'action' => 'digitallibraryreport'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                            </li>
                            <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Virtual CFO-report'), ['controller' => 'Reports', 'action' => 'virtualcforeport'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                            </li> -->
                            <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Monthly Report'), ['controller' => 'Reports', 'action' => 'servicereport'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                            </li>
                            <li class="sidebar-item"><?php echo $this->Html->link(__('<i class="mdi  mdi-account-box"></i>&nbsp; Date Report'), ['controller' => 'Reports', 'action' => 'dateservicereport'], ['escape' => false, 'class' => 'sidebar-link']); ?>
                            </li>
