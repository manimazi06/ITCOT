...
<div class="container-fluid">
         <div class="step-app row justify-content-center" id="demo">
		  <ul class="step-steps col-lg-12 col-md-12 col-sm-12" >
               ...
               <li >
                  <div class="list-nav" data-step-target="step3">
                     <div class="icon">
                              ...
                              <table class="table table-bordered responsive">
								<thead class="table-dark">
									<tr class="text-center">
										...
										<th style="width:10%;">	<button type="button" class="btn btn-success btn-xs" onclick="educationadding();"><i class="fa fa-plus-circle"></i>&nbsp;Add</button>
										</th>
									</tr>
								</thead>
                                   ...
                                   <table class="table table-bordered responsive">
									<thead class="table-dark">
										<tr class="text-center">
											...
											<th style="width:10%;">	<button type="button" class="btn btn-success btn-xs" onclick="trainingadding();"><i class="fa fa-plus-circle"></i>&nbsp;Add</button>
											</th>
										</tr>
									</thead>
                                   ...
                                   <table class="table table-bordered responsive">
									<thead class="table-dark">
										<tr class="text-center">
											...
											<th style="width:15%;">Duration</th>
											<th style="width:10%;"><button type="button" class="btn btn-success btn-xs" onclick="workadding();"><i class="fa fa-plus-circle"></i>&nbsp;Add</button>
											</th>
										</tr>
									</thead>
