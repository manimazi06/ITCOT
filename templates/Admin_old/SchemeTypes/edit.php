...
<div class="card mt-5">
    <div class="card-header" style="background-color: #243e04;">
        <h4 class="mb-0 text-white">Edit Scheme Types</h4>
    </div>
    <div class="card-body">
   ...
   <div class="row">         
			<div class="col-sm-12 col-md-3">
                <div class="mb-4">
                    <label for="inputlname" class="control-label col-form-label">Schemes<span class="text-danger">*</span></label>
                    <?php echo $this->Form->control('scheme_id', ['label' => false, 'class' => 'form-control select', 'empty' => 'Select Schemes','options'=>$schemes, 'required']); ?>
                </div>
            </div>                        
        </div>
