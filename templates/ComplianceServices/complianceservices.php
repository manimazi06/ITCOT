							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="uniongov-content text-start">
									<div class="fw-semibold">
										...
										<h4 class="text-gray-900 fw-bold text-center py-1" style="font-size: 1.5rem !important;margin-top:-10px">Apply for Compliance Services</h4>
									</div>
									...
									<div class="row ">
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Name of the Contact Person<span class="text-danger">*</span></label>
												<?php echo $this->Form->control('name', ['label' => false, 'class' => 'form-control name', 'type' => 'text', 'minlength' => '1', 'maxlength' => '25', 'onkeypress' => "return AvoidSpace(this.value)", 'placeholder' => 'Contact Person name', 'required']); ?>
												<span id="lblError" class="error"></span>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Mobile</label><span class="text-danger">*(+91)</span>
												<?php echo $this->Form->control('mobile_no', ['label' => false, 'class' => 'form-control num', 'minlength' => "1", "maxlength" => "10",  'type' => 'text', 'onclick' => "ValidateMobileNumber()", 'placeholder' => 'Mobile No', 'required']); ?>
												<span id="lblError" class="error"></span>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Email<span class="text-danger">*</span></label>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Name of the Project<span class="text-danger">*</span></label>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Project Location<span class="text-danger">*</span>
												</label>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Pincode<span class="text-danger">*</span>
												</label>
												<?php echo $this->Form->control('pincode', ['label' => false, 'class' => 'form-control num', 'type' => 'text', 'maxlength' => 6, 'placeholder' => 'Pincode','onchange'=>'pincode_data()', 'required']); ?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">District<span class="text-danger">*</span>
												</label>
												...
												<?php echo $this->Form->control('location', ['label' => false, 'class' => 'form-control', 'style' => 'display:none;','id'=>'location', 'placeholder' => 'Location']); ?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											...
											<label for="name" class="form-label text-dark">Land Area <span class="text-danger">*</span></label>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Total Built-up area<span class="text-danger">*</span>
												</label>
												...
												<div class="input-group mb-3">
													<input type="text" class="form-control num" aria-label="Text input with dropdown button" name="total_buildup_area" placeholder="Total Built-up area" style="width:100px;">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark"> No.of Employees<span class="text-danger">*</span>
												</label>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Power Requirement<span class="text-danger">*</span>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark">Project Cost<span class="text-danger">*</span>

												</label>
												<?php echo $this->Form->control('project_cost', ['label' => false, 'class' => 'form-control num', 'type' => 'text', 'data-type' => 'currency', 'placeholder' => 'Project Cost', 'onkeypress' => "return AvoidSpace(this.value)", 'onblur' => 'notowords()','maxlength'=>'10','data-rule-required' => true, 'data-msg-required' => 'Project cost should not more than 10', 'required']); ?>
												<?php echo $this->Form->control('words', ['label' => false, 'class' => 'form-control', 'id' => 'words', 'type' => 'textarea', 'rows' => '2', 'data-type' => 'currency', 'style' => 'display:none;', 'placeholder' => 'Project Cost in Words', 'readonly']); ?>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark"> Services required for obtaining approvals from<span class="text-danger">*</span>
												</label>
												...
												<table style="width: 580px;">
													...
													foreach ($serviceCompliances as $key => $value) {
														...
														// exit();
													?>
													<!-- <div style="display:none;" name="arr[]"></div> -->
														<tr>
															<td>
										...
										<div class="col-lg-10 col-md-10 col-sm-12 offset-lg-1 offset-md-1 mt-5 ">
											<div class="list1-head">
												<label for="name" class="form-label text-dark"> Product Details<span class="text-danger">*</span>
												</label>
													...
													<table class="table table-bordered">
														...
														<tbody class="comadding">
															...
															<tr class="complaince_row_in_post">
																...
																<td align="center" style="margin-top:5px;">1.</td>
																<td>
																...
																<td>
																	<?php echo $this->Form->control('complaince.0.capacity', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Capacity', 'data-rule-required' => true, 'data-msg-required' => 'Enter Capacity', 'onkeypress' => "return AvoidSpace(this.value)", 'data-msg-required' => 'Enter Capacity']); ?>

																</td>
																<td>
																	<?php echo $this->Form->control('complaince.0.capacity_pervalue', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $cap_dropdown, 'label' => false, 'error' => false, 'empty' => 'Select','data-rule-required' => true, 'data-msg-required' => 'Enter Per Capacity','required'=>'true']); ?>
																	<span id="lblError" class="error"></span>
																</td>
																<td>
																	<?php echo $this->Form->control('complaince.0.unit', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Unit', 'data-rule-required' => true, 'data-msg-required' => 'Enter Unit', 'data-msg-required' => 'Enter Unit']); ?>
	...
	<script>
		function checkbox_others(id) {
			...
			//alert(isChecked);
			if (isChecked === true && id == 12) {

				$('#others').show();
			} else if (isChecked === false && id == 12) {
				$('#others').val('');
				$('#others').hide();
		...
		$("#FormID").validate({
			...
			messages: {
				...
				'project_cost': {
					...
					//required: "Project cost should not more than 10"
		...
		function notowords() {
			var words = $('#project-cost').val();
			if (words != '') {
				$.ajax({
					async: true,
					dataType: "html",
					url: '<?php echo $this->Url->webroot; ?>ajaxnowords/' + words,
		...
		function pincode_data() {
			...
			if (pincode != '') {
				$.ajax({
					async: true,
					dataType: "html",
					url: '<?php echo $this->Url->webroot; ?>ajaxpincode/' + pincode,
