									...
									<div class="row ">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												...
												<?php echo $this->Form->control('mobile_no', ['label' => false, 'class' => 'form-control num', 'minlength' => "10", "maxlength" => "12",  'type' => 'text', 'onclick' => "ValidateMobileNumber()",'placeholder' => 'Mobile No', 'required']); ?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											...
											<div class="input-group mb-3">
												...
												<?php echo $this->Form->control('land_unit', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $unit, 'label' => false, 'error' => false,'empty'=>'Units']); ?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												...
												<div class="input-group mb-3">
													...
													<?php echo $this->Form->control('totalarea_unit', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $unit, 'label' => false, 'error' => false,'empty'=>'Units']); ?>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												...
												<input type="text" class="form-control num" aria-label="Text input with dropdown button" name="power_req" placeholder = 'Power Requirement' style="width:100px;">
													<?php echo $this->Form->control('powerreq_unit', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $unit, 'label' => false, 'error' => false,'empty'=>'Units']); ?>
													<!-- <ul class="dropdown-menu dropdown-menu-end">
														<li><a class="dropdown-item" href="#">Sq ft</a></li>
														<li><a class="dropdown-item" href="#">sq m</a></li>
														<li><a class="dropdown-item" href="#">Acre</a></li>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 mt-5 ">
											<div class="list1-head">
												...
												<?php echo $this->Form->control('project_cost', ['label' => false, 'class' => 'form-control num', 'type' => 'text','placeholder' => 'Project Cost', 'minlength' => '1', 'maxlength' => '25', 'onkeypress' => "return AvoidSpace(this.value)", 'required']); ?>
