            ...
            <div class="d-flex flex-column flex-column-fluid" id="virtual_id">
              ...
              <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                  <!--begin::Frameworks-->
                  <div class="d-flex flex-column mb-lg-10 mb-20" id="kt_app_frameworks" style="padding-top: 15rem">
                    <!--begin::Heading-->
                    ...
                    <!--begin::Description-->
                    <div class="text-gray-700 text-start fs-4 fw-semibold opacity-75" style="margin-top: 20px">
                      <p>
