 ...
 <!--end::Body-->
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 pb-5 ">
                  <div class="row d-flex justify-content-center" >
                      ...
                      <!--begin::Heading--><div class="notice col-lg-6 col-md-6 col-sm-12  bg-light-primary rounded border-primary border border-dashed rounded-3 p-6 text-center">
                     
                        <!--begin::Title-->
                        <?php if($user['digi_library_flag'] == 0){ ?>
                          <h3 class="mt-2">Pay Rs.1000/- and get subscribed</h3>
			    <p>
			    <input class="mt-2"  type="checkbox">  &nbsp;  I have read and agree to the terms and conditions
              </p>
        	<a class="btn btn-light-primary "  style="border-radius:5px;color:white;padding:10px;" href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'digitalpayment']); ?>">SUBSCRIBE NOW</a>
			   <?php }
         else if($user['digi_library_flag'] == 1){ ?>
  			    <a class="btn btn-light-primary" style="border-radius:5px;color:white;font-size:14px;" href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'schemes']); ?>">VIEW &nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
			   <?php } ?>
                        <!--end::Title-->             
                      </div> </div>
                </div>
