											...
											<div class="list1-head my-3 ">
												<ul style="list-style: none;">
													<?php foreach ($project_profile_1 as $profile) { ?>
														<a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'projectprofilevalue', $profile['id']]); ?>">
															<li><i class="fas fa-long-arrow-alt-right" style="color: #253b5f;"> </i> &nbsp;<?php echo $profile['name']; ?></li>
														</a>
													<?php } ?>
												</ul>
											</div>
