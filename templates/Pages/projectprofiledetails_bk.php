	...
	<div class="toolbar py-5 py-lg-5" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
			<div class="page-title d-flex flex-column me-3">
				<h1 class="d-flex text-dark fw-bold my-1 fs-3">  <h4> <?php echo $Profile_details[0]['project_profile']['name']; ?></h4>			
		...
		<div class="row">
		  ...
		  <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded" id="kt_datatable_dom_positioning" >
			  ...
			  <tbody class="text-gray-600 fw-semibold">
				 <?php $i=1; foreach($Profile_details as $project){ ?>
				 <tr class="row-odd">
				  <td scope="row"><?php echo $i; ?></td>
				  <td><?php echo $project['project_name']; ?></td>
				  <td>Rs.&nbsp;<?php  echo  ($project['project_cost'])?ltrim($fmt->formatCurrency((float)$project['project_cost'],'INR'),'₹'):'0.00'; ?></td>
				  <td><a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'pdfdownload214',$project['id']]); ?>">View/Download</a> </td>
				 </tr>
				 <?php $i++; } ?>				
			  </tbody>
			</table>
