							...
							<div class="card">
								...
								<div class="card-body p-0">
									...
									<div class="card-px text-center py-20 my-10">
										...
										<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 d-flex justify-content-end" style="align-items: center;"> <p>For more details, visit <a href="" style="color: #00AAFF;">MRIN Scheme </a> </p></div>
              <div class="col-lg-6 col-md-6 col-sm-12 d-flex justify-content-start" ><a href="#" class="btn btn-primary" 
			  data-bs-toggle="modal" 
			  data-bs-target="#kt_modal_add_customer"> Download ISAM Scheme</a>
				</div>
            </div>
										<!--end::Action-->
									</div>
