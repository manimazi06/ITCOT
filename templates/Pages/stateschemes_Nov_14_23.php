...
<div class="container" style="min-height: 600px;">
  <div class="row pb-5">
    <div class="col-lg-10 col-md-10 col-sm-12 offset-lg-1 offset-md-1">
      ...
      <?php } ?> -->
                        <?php echo $this->Form->control('department_id', ['label' => false, 'class' => 'form-select', 'empty' => 'Select State','id'=>'drop_down', 'options' => $departments_dropdown, 'required', 'onchange' => 'departments(this.value)']); ?>
                      ...
                      <ul style="list-style: none;">
                        <?php foreach ($state_schemes_2 as $state) { ?>
                          <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'schemeview', $state['id']]); ?>">
                            <li><i class="fas fa-long-arrow-alt-right" style="color: #253b5f;"> </i> &nbsp;<?php echo $state['name']; ?></li>
                          </a>
                        <?php } ?>
                      </ul>
                    </div>
