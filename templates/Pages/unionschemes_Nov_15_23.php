							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="uniongov-content text-start">
									...
									<!--end::Content-->
											 ...
											 <div class="row">
										 <div class="col-lg-6 col-md-6 col-sm-12 my-5 ps-5 offset-3">
												...
												<ul style="list-style: none;">
													<!-- <?php foreach ($union_schemes_1 as $union) { ?>
														<a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'schemeview', $union['id']]); ?>">
															<li> <i class="fas fa-long-arrow-alt-right" style="color: #253b5f;"> </i> &nbsp;<?php echo $union['name']; ?></li>
														</a>
													<?php } ?> -->
													<?php echo $this->Form->control('department_id', ['label' => false, 'class' => 'form-select', 'empty' => 'Select Ministry', 'options' => $departments_dropdown, 'required', 'onchange' => 'departments(this.value)']); ?>
  ...
  <div class="container" >
	...
	<script type="text/javascript">
		function departments(val) {
			...
			if(val == 13){
				window.location.href = 'https://itcot.demodev.in/pages/msmedivisions/'+ schemeType + '/' + val;
			}else{
			window.location.href = 'https://itcot.demodev.in/pages/schemeview/'+ schemeType + '/' +val;
