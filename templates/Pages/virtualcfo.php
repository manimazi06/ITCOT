  ...
  <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
      <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
        ...
        <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
          ...
          <div
            id="kt_app_hero"
            class="app-hero app-hero-default mb-5 mb-lg-15"
            style="background: #f4de6d"
          >
            <!--begin::Hero container-->
            <div id="kt_app_hero_container" class="app-container container-xxl">
              <!--begin::Hero wrapper-->
              <div
                class="app-hero-wrapper pt-10 pt-xl-20"
                data-bs-theme="light"
              >
                <!--begin::Row-->
                <div class="row pt-lg-10">
                  ...
                  <div class="col-lg-6 order-2 order-lg-1">
                    <!--begin::Preview-->
                    <div
                      class="preview w-100 w-lg-500px w-xl-550px h-150px h-md-275px h-xl-300px"
                    >
                      <div
                      ...
                      <form
                          ...
                          <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                              <label for="inputlname" class="fs-5 fw-semibold mb-2"> States<span class="text-danger">*</span></label>
    ...
    background-color: var(--bs-gray-100);' ,'empty' => 'Select State','options'=>$virtualcfoStates]); ?>
                         ...
                         <div class="text-center mt-4">
                          ...
                          <button
                                ...
                                style="background: #eba939;position: relative; z-index: 1000"
                              >
                  ...
                  >
                    ...
                    <div class="">
                      <!--begin::Heading-->
                      <h1
                        class="fs-1 fs-lg-2hx fw-bold text-gray-900 mb-5 letter-spacing mt-n1"
                      >
                        Virtual CFO
                      </h1>
                      <!--end::Heading-->
                      ...
                      >
                        <a target="_blank" class="btn btn-dark">Apply Now</a>
            ...
            <div class="d-flex flex-column flex-column-fluid">
              ...
              <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                >
                  <!--begin::Frameworks-->
                  <div
                    class="d-flex flex-column mb-lg-10 mb-20"
                    id="kt_app_frameworks"
                    style="padding-top: 15rem"
                  >
                    <!--begin::Heading-->
                    <div class="d-flex flex-column flex-center mb-10 mb-lg-20">
                      <!--begin::Subtitle-->
                      <h3
                        class="d-flex text-dark fs-2hx fw-bolder mb-10 letter-spacing"
                      >
                      ...
                      <!--begin::Description-->
                      <div
                        class="text-gray-700 text-center fs-4 fw-semibold opacity-75"
                      >
                        A Virtual CFO (Chief Financial Officer) is a financial
                        professional who provides CFO-level services to
                      ...
                      <div class="flex-lg-row-fluid ms-lg-7 ms-xl-12">
                        ...
                        <div class="tab-content">
                          ...
                          <div
                            ...
                            id="kt_app_framework_html"
                            role="tabpanel"
                          >
                            <!--begin::Heading-->
                            <div class="d-flex flex-column mb-10">
                              <h2
                                class="text-gray-900 fw-bold mb-1 fs-2 letter-spacing"
                              >
                            ...
                            <div class="row g-10">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="d-flex flex-column mb-3">
                                  <!--begin::Heading-->
                                  <h3
                                    class="d-flex d-flex flex-column justify-content-start mb-4"
                                  >
                                    <!--begin::Logo-->
                                    <div
                                      class="d-flex flex-center flex-shrink-0 me-3 mb-5 bg-gray-200 rounded-1"
                                      style="height: 42px; width: 42px"
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/001.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                    ...
                                    <!--begin::Title-->
                                    <div
                                      class="text-gray-800 fs-4 fw-bold letter-spacing"
                                    >
                                      Financial Strategy:
                                    </div>
                                    <!--end::Title-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/financial_planning_and_analysis.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/financial_reporting.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/cash-flow.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/risk_management.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/cost_management.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/investor_relations.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/tax_planning.png"
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                                ...
                                <div class="d-flex flex-column mb-3">
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        class="w-40px align-start"
                                        src="/webroot/ITCOT/img/acquisition.png "
                                        alt=""
                                      />
                                    </div>
                                    <!--end::Logo-->
                    ...
                    <!--begin::Description-->
                    <div
                      class="text-gray-700 text-start fs-4 fw-semibold opacity-75"
