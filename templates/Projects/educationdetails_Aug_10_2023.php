								  ...
								  <tbody class="eduadding">
								    <?php if($education_count == 0){ ?>
									  <tr class="edupresent_row_in_post">
											...
											<td><?php echo $this->Form->control('educationqualification.0.year_passing', ['class' => 'form-control num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Year Passing','data-rule-required'=>true,'data-msg-required'=>'Enter Year Passing','maxlength'=>4]); ?>
											</td>
											<td>
											</td>
										</tr>
									   ...
									   <?php if($work_count == 0){ ?>
									        <tr class="workpresent_row_in_post">
												...
												<td><?php echo $this->Form->control('work.0.organisation', ['class' => 'form-control name', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => ' Organisation','data-rule-required'=>true,'onkeypress'=>"return AvoidSpaceorg(this.value)",'data-msg-required'=>'Enter Organisation']); ?>
												 ...
												 <td><?php echo $this->Form->control('work.0.position', ['class' => 'form-control name', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Position','data-rule-required'=>true,'onkeypress'=>"return AvoidSpacepos(this.value)",'data-msg-required'=>'Enter Position']); ?>
												</td>
												 <td><?php echo $this->Form->control('work.0.nature_work', ['class' => 'form-control name', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Nature of Work','data-rule-required'=>true,'onkeypress'=>"return AvoidSpacenature(this.value)",'data-msg-required'=>'Enter Nature of Work']); ?>
												</td>
											...
											<?php }else{ 
											 ...
											 <tr class="workpresent_row_in_post work_<?php echo $key2; ?>">
												...
												<td><?php echo $this->Form->control('work.'.$key2.'.organisation', ['class' => 'form-control name', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => ' Organisation','data-rule-required'=>true,'data-msg-required'=>'Enter Organisation','onkeypress'=>"return AvoidSpaceorg(this.value,$key2)",'value'=>$value2['organisation']]); ?>
												 ...
												 <td><?php echo $this->Form->control('work.'.$key2.'.position', ['class' => 'form-control name', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Position','data-rule-required'=>true,'data-msg-required'=>'Enter Position','onkeypress'=>"return AvoidSpacepos(this.value,$key2)",'value'=>$value2['position']]); ?>
												</td>
												 <td><?php echo $this->Form->control('work.'.$key2.'.nature_work', ['class' => 'form-control name', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Nature of Work','data-rule-required'=>true,'data-msg-required'=>'Enter Nature of Work','onkeypress'=>"return AvoidSpacenature(this.value,$key2)",'value'=>$value2['nature_work']]); ?>
												</td>
