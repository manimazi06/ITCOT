									...
									<thead class="table-dark">
									  ...
									  <tbody class="rawadding">
									        <tr>
												...
												<td>
												  <?php echo $this->Form->control('electricity_requirement', ['class' => 'form-control requirement num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Requirement','onkeyup'=>'calculaterequirement()','data-rule-required'=>true,'data-msg-required'=>'Enter Requirement','value'=>$utilities['electricity_requirement']]); ?>
											...
											<tr>
												...
												<td><?php echo $this->Form->control('water_requirement', ['class' => 'form-control requirement num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Requirement','onkeyup'=>'calculaterequirement()','data-rule-required'=>true,'data-msg-required'=>'Enter Requirement','value'=>$utilities['water_requirement']]); ?>
												</td>
												<td>
											...
											<tr>
												...
												<td><?php echo $this->Form->control('oil_requirement', ['class' => 'form-control requirement num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Requirement','onkeyup'=>'calculaterequirement()','data-rule-required'=>true,'data-msg-required'=>'Enter Requirement','value'=>$utilities['oil_requirement']]); ?>
												</td>
												<td>
											...
											<tr>
												...
												<td><?php echo $this->Form->control('other_requirement', ['class' => 'form-control requirement num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Requirement','onkeyup'=>'calculaterequirement()','data-rule-required'=>true,'data-msg-required'=>'Enter Requirement','value'=>$utilities['other_requirement']]); ?>
												</td>
												<td>
