									...
									<thead class="table-dark">
									  ...
									  <tbody class="rawadding">
									        <tr>
												...
												<td>
												  <?php echo $this->Form->control('capital_finance_value', ['class' => 'form-control financevalue amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'onkeyup'=>'calculatefinancevalue()', 'placeholder' => 'Value','data-rule-required'=>true,'data-msg-required'=>'Enter Value','value'=>$means_Finance['capital_finance_value'],'style'=>'text-align:end']); ?>
												  <?php echo $this->Form->control('mean_finance_id', ['label' => false, 'error' => false,'type'=>'hidden','value'=>$means_Finance['id']]); ?>

												</td>
												<td><?php echo $this->Form->control('capital_finance_remark', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Remarks','data-rule-required'=>false,'data-msg-required'=>'Enter Remarks','type'=>'textarea','rows'=>3,'value'=>$means_Finance['capital_finance_remark']]); ?>
												</td>									
											</tr>
											<tr>
												...
												<td><?php echo $this->Form->control('subsidy_value', ['class' => 'form-control financevalue amount','type'=>'text', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'onkeyup'=>'calculatefinancevalue()', 'placeholder' => 'Value','data-rule-required'=>true,'data-msg-required'=>'Enter Value','value'=>$means_Finance['subsidy_value'],'style'=>'text-align:end']); ?>
												</td>
												<td><?php echo $this->Form->control('subsidy_remark', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Remarks','data-rule-required'=>false,'data-msg-required'=>'Enter Remarks','type'=>'textarea','rows'=>3,'value'=>$means_Finance['subsidy_remark']]); ?>
												</td>										
										   </tr>
											<tr>
												...
												<td><?php echo $this->Form->control('loan_value', ['class' => 'form-control financevalue amount','type'=>'text', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'onkeyup'=>'calculatefinancevalue()', 'placeholder' => 'Value','data-rule-required'=>true,'data-msg-required'=>'Enter Value','value'=>$means_Finance['loan_value'],'style'=>'text-align:end']); ?>
												</td>
												<td><?php echo $this->Form->control('loan_remark', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Remarks','data-rule-required'=>false,'data-msg-required'=>'Enter Remarks','type'=>'textarea','rows'=>3,'value'=>$means_Finance['loan_remark']]); ?>
												</td>										
											</tr>
											<tr>
												...
												<td><?php echo $this->Form->control('investment_value', ['class' => 'form-control financevalue amount','type'=>'text', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'onkeyup'=>'calculatefinancevalue()', 'placeholder' => 'Value','data-rule-required'=>true,'data-msg-required'=>'Enter Value','value'=>$means_Finance['investment_value'],'style'=>'text-align:end']); ?>
												</td>
												<td><?php echo $this->Form->control('investment_remark', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Remarks','data-rule-required'=>false,'data-msg-required'=>'Enter Remarks','type'=>'textarea','rows'=>3,'value'=>$means_Finance['investment_remark']]); ?>
												</td>											
											</tr>
											 <tr>
												...
												<td><?php echo $this->Form->control('other_value', ['class' => 'form-control financevalue amount','type'=>'text', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'onkeyup'=>'calculatefinancevalue()', 'placeholder' => 'Value','data-rule-required'=>true,'data-msg-required'=>'Enter Value','value'=>$means_Finance['other_value'],'style'=>'text-align:end']); ?>
												</td>
												<td><?php echo $this->Form->control('other_remark', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Remarks','data-rule-required'=>false,'data-msg-required'=>'Enter Remarks','type'=>'textarea','rows'=>3,'value'=>$means_Finance['other_remark']]); ?>
												</td>											
											</tr>	
									</tbody>
									<tfoot>
