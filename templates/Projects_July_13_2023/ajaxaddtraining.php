<tr class="trainingdelete_docdetails_class_<?php echo $j ?> trainingpresent_row_in_post">                                              
    <td align="center" style="width:2%;"><?php echo $j+1; ?></td>
		...
		<td><?php echo $this->Form->control('special.'.$j.'.from_date', ['class' => 'form-control datepicker'.$j.'', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'From Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'trainingdays('.$j.')']); ?>
		</td>
		 <td><?php echo $this->Form->control('special.'.$j.'.to_date', ['class' => 'form-control datepicker'.$j.'', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'To Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'trainingdays('.$j.')']); ?>
		</td>
