									    ...
									    <?php if($training_count == 0){ ?>
										  <tr class="trainingpresent_row_in_post">
												...
												<td><?php echo $this->Form->control('special.0.training_in', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => ' Training In','data-rule-required'=>true,'data-msg-required'=>'Enter Training In']); ?>
												 ...
												 <td><?php echo $this->Form->control('special.0.from_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'From Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'trainingdays(0)']); ?>
												</td>
												 <td><?php echo $this->Form->control('special.0.to_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'To Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'trainingdays(0)']); ?>
												</td>
											...
											<?php }else{ 
											 ...
											 <tr class="trainingpresent_row_in_post">
												...
												<td><?php echo $this->Form->control('special.'.$key1.'.from_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'From Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'trainingdays('.$key1.')','value'=>($value1['from_date'])?date('d-m-Y',strtotime($value1['from_date'])):'']); ?>
												 ...
												 <td><?php echo $this->Form->control('special.'.$key1.'.to_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'To Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'trainingdays('.$key1.')','value'=>($value1['to_date'])?date('d-m-Y',strtotime($value1['to_date'])):'']); ?>
												</td>
												 <td><?php echo $this->Form->control('special.'.$key1.'.duration', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Duration','data-rule-required'=>false,'data-msg-required'=>'Enter Duration','value'=>$value1['duration'],'readonly']); ?>
												</td>
									   ...
									   <?php if($work_count == 0){ ?>
									        <tr class="workpresent_row_in_post">
												...
												<td><?php echo $this->Form->control('work.0.organisation', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => ' Organisation','data-rule-required'=>true,'data-msg-required'=>'Enter Organisation']); ?>
												 ...
												 <td><?php echo $this->Form->control('work.0.from_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'From Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'workingdays(0)']); ?>
												</td>
												 <td><?php echo $this->Form->control('work.0.to_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'To Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'workingdays(0)']); ?>
												</td>
											...
											<?php }else{ 
											 ...
											 <tr class="workpresent_row_in_post">
												...
												<td><?php echo $this->Form->control('work.'.$key2.'.organisation', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => ' Organisation','data-rule-required'=>true,'data-msg-required'=>'Enter Organisation','value'=>$value2['organisation']]); ?>
												 ...
												 <td><?php echo $this->Form->control('work.'.$key2.'.from_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'From Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'workingdays('.$key2.')','value'=>($value2['from_date'])?date('d-m-Y',strtotime($value2['from_date'])):'']); ?>
												</td>
												 <td><?php echo $this->Form->control('work.'.$key2.'.to_date', ['class' => 'form-control flatpickr', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'To Date','data-rule-required'=>true,'data-msg-required'=>'Select Date','onchange'=>'workingdays('.$key2.')','value'=>($value2['to_date'])?date('d-m-Y',strtotime($value2['to_date'])):'']); ?>
												</td>
