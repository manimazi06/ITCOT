									...
									<?php }else{ 
									  ...
									  ?>									
									   <tr class="productionpresent_row_in_post">														  
											...
											<td><?php echo $this->Form->control('production.'.$key.'.item', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Item','data-rule-required'=>true,'data-msg-required'=>'Enter Item','value'=>$value['item']]); ?>
									  ...
									  <tbody class="rawadding">
									   <?php if($raw_count == 0){ ?>
									        <tr class="rawpresent_row_in_post">
												<td align="center">1.</td>												
												<td><?php echo $this->Form->control('raw.0.item', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Item','data-rule-required'=>true,'data-msg-required'=>'Enter Item']); ?>
												</td>
