									...
									<thead class="table-dark">
									  ...
									  <tbody class="rawadding">
									        <tr>
												...
												<td><?php echo $this->Form->control('raw_value', ['class' => 'form-control workingvalue amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'onkeyup'=>'calculateworkingvalue()', 'placeholder' => 'Value','data-rule-required'=>true,'data-msg-required'=>'Enter Value','value'=>$working_capital['raw_value'],'style'=>'text-align:end']); ?>
												</td>									
											</tr>
											<tr>
												<td align="center">2.</td>												
