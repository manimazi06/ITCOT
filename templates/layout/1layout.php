      ...
      <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
          ...
          >
            ...
            <!-- container-xxl -->
            <div
              class="header-menu-container d-flex flex-stack h-lg-75px w-100"
              id="kt_header_nav"
            ...
            >
              ...
              <div class="d-flex align-items-center me-5">
                <a href="">
                  <img
                    alt="Logo"
                    src="<?= $this->Url->build('/') ?>images/logo.jpg"
                    class="theme-light-show h-50px h-lg-50px"
               
                  />
                  <img
                    alt="Logo"
                    src="<?= $this->Url->build('/') ?>images/logo.jpg"
                    class="theme-dark-show h-50px h-lg-50px"
                  />
                </a>
              </div>
              <!--end::Header Logo-->
                ...
                <!--begin::Menu-->
                <div
                  class="justify-content-center menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-state-primary menu-title-gray-800 menu-arrow-gray-400 align-items-stretch flex-grow-1 my-5 my-lg-0 px-2 px-lg-0 fw-semibold fs-6"
                  id="#kt_header_menu"
                  data-kt-menu="true"
                >
                  <!--begin:Menu item-->
                  ...
                  >
                    ...
                    <!--begin:Menu sub-->
                    <div
                      class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-lg-200px" style="width: 200px;"
                    >
                      <!--begin:Pages menu-->
                        ...
                        <div class="tab-content py-4 py-lg-8 px-lg-7">
                          ...
                          >
                                <div class="row">
                                  ...
                                  <div class="col-lg-3 mb-6 mb-lg-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <!-- <a
                                        href="../../demo11/dist/pages/user-profile/overview.html"
                                        class="menu-link"
                                      > -->
							   ...
							   <?php if($user_id == ''){ ?>							   
								  ...
								  <span class="menu-title">Project Report</span></a>
							   <?php }else{ ?>
							      <?php if($project_count == 0){ ?>
							  	  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'basicdetails']); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
							  	  <?php  }else{ ?>
								  
								  <?php  if($project['step_count'] == 1){ ?>
 								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'entitydetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 2){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'educationdetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 3){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'manufacturingdetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 4){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'manpowerdetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 5){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'projectcostdetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 6){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'profitabilitydetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
								  <?php }else if($project['step_count'] == 7){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'suppliementarydetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 8){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'referencedetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
 								  <?php }else if($project['step_count'] == 9 || $project['step_count'] == 10){ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'paymentdetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
								  <?php  }else{ ?>
								  <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'basicdetails',$project['id']]); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Project Report</span></a>
							      <?php  } ?>
								<?php } ?>
								<?php } ?>
							 </li>                                        
                                    ...
                                    <div class="menu-item p-0 ">
                                      ...
                                      <li>
						              <a class="nav-link" href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'statuscheck']); ?>"><i class="mdi  mdi-account-box"></i>  <span class="menu-link py-3">
									  <i class="mdi  mdi-account-box"></i>   <span class="menu-title">Status Check</span></a></li>
                ...
                <?php if($user_id == ''){ ?>
				<a class="menu-item btn btn-sm btn-primary fw-bold w-100 w-lg-auto" style="background: #eba939;"  
                    data-bs-toggle="tooltip"
                    data-bs-trigger="hover"
                    data-bs-dismiss-="click"
                    href="<?php echo $this->Url->build(['controller' => 'Users', 'action' => 'login']); ?>" target="_blank">login
                ...
                >
                  ...
                  >
                    ...
                    <div class="menu-item px-5">
                      <a
                        href="<?php echo $this->Url->build(['controller' => 'Users', 'action' => 'changepassword']); ?>"
