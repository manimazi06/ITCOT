...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flatpickr/4.6.9/themes/airbnb.min.css" integrity="sha512-s0ZrPrgzmwoIlxJR7XKxtUbqRm103b8HS0wOnWnJSsKO1prue4aGp1XJRGl9OADSKygpFcCQ/xlieqQ773/aAw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
          ...
          <div class="header-menu-container d-flex flex-stack h-lg-75px w-100" id="kt_header_nav" style="display: inherit !important;">
            ...
            <div class="header-menu flex-column flex-lg-row" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
              ...
              <div class="justify-content-center menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-state-primary menu-title-gray-800 menu-arrow-gray-400 align-items-stretch flex-grow-1 my-5 my-lg-0 px-2 px-lg-0 fw-semibold fs-6" id="#kt_header_menu" data-kt-menu="true">
                ...
                <!-- <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                                  <li class="nav-item1">
                    <a class="nav-link" style="color: #FF3147" href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'aboutitcot']); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-link py-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          ...
                          <li>
                            ...
                            <?php } else { ?>
                              ...
                              <a class="menu-link" href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'projectreport']); ?>"><i class="mdi  mdi-account-box"></i> <span class="menu-title">Modify Existing</span></a>
                            <?php  } ?>
                ...
                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                  ...
                  <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                      ...
                      <a class=" nav-link" style="color: #FF3147" href="<?php echo $this->Url->build(['controller' => 'ComplianceServices', 'action' => 'complianceservices']); ?>">
                        <span class="menu-link py-3 text-start">

                          <span class="menu-title">Approvals/Clearances</span></a>
                    ...
                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                      ...
                      <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
                        ...
                        <div class="menu-item">
                          <!--begin:Menu link-->
                          <!-- <a class="menu-link py-3" href=""> -->
                          <a class="menu-link py-3" href="<?php echo $this->Url->build(['controller' => 'Eprcertification', 'action' => 'eprcertification']); ?>">
                            <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Apply Online</span>
              ...
              <div class="flex-shrink-0 p-4 p-lg-0 me-lg-2">
                ...
                <?php if ($user_id == '') { ?>
                  <a class="menu-item btn btn-sm btn-primary fw-bold w-100 w-lg-auto" style="background: #eba939;" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" href="<?php echo $this->Url->build(['controller' => 'Users', 'action' => 'login']); ?>">login
                    <!-- <img src="<?php echo $this->Url->build(); ?>assets/icons/Vector.png" alt="" /> -->
                    <img src="<?php echo $this->Url->image('../images/users/Vector.png'); ?>" alt="">
                  </a>
                <?php } else { ?>
      ...
      <div class="row mt-5" style="background-color: #093875">
        <div class="col-lg-3 col-md-3 col-sm-12">
          <div class="foot-1 mt-5">
            <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'index']); ?>"> <img src="<?php echo $this->Url->build('/'); ?>assets/image/logo1.png" alt="logo" /></a>
            <p>
              ITCOT Limited, also known as Industrial and Technical Consultancy Organization of Tamil Nadu Limited,
              is a Deemed Government Company incorporated in 1979 as a joint venture of Development Financial Institutions,
              State Development Corporations and Commercial Banks.
            </p>
          </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12">
          <div class="foot-2 mt-5">
            ...
            <ul style="list-style: none">
              ...
              <a href="<?php echo $this->Url->build(['controller' => 'Projects', 'action' => 'basicdetails']); ?>">

                <li>Project Report</li>
              </a>
              <!-- <a href="#" style="text-decoration: none;"> -->
              <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'digitallibrary']); ?>">
                <li>Digital Library</li>
              </a>
              <!-- <a href="#" style="text-decoration: none;"> -->
              <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'statuscheck']); ?>">
                <li>Status Check</li>
              </a>
            </ul>
          </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
          <div class="foot-3 mt-5">
            <p>Schemes</p>
            <ul style="list-style: none">
              <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'unionschemes']); ?>">
                <!-- <a href="#" style="text-decoration: none;"> -->
                <li>MSME Schemes</li>
              </a>
              <!-- <a href="#" style="text-decoration: none;"> -->
              <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'unionschemes', 1]); ?>">
                <li>Union Government Schemes</li>
              </a>
              <!-- <a href="#" style="text-decoration: none;"> -->
              <a href="<?php echo $this->Url->build(['controller' => 'Pages', 'action' => 'stateschemes', 2]); ?>">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
          <div class="foot-4 mt-5">
            ...
            <ul style="list-style: none">
              <li>50-A, Greams Road, Chennai 600 006</li>
